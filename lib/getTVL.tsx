...
import { getDebtStates, getLatestRateById, getLoans, getWrappers } from "../subgraphs/subgraph-ovm";
...
export const getTVL = async () => {
  ...
  const fetchLoans = async (block: number, network: string) => {
    const loanCall = await getLoans(
      network,
      { block: { number: block }, where: { isOpen: true }, orderBy: 'collateralAmount', orderDirection:'desc' },
    ...
    const activeLoans = loanCall.reduce(
      (sum: number, cur) => {
  ...
  const ovmCurrentLoan = await fetchLoans(blocks.ovm.ovmCurrentBlock, optimism_url)
  const mainCurrentLoan = await fetchLoans(blocks.main.mainCurrentBlock, mainnet_url)
  ...
  const ovmFourHourLoan = await fetchLoans(blocks.ovm.ovmFourHourBlock, optimism_url)
  const mainFourHourLoan = await fetchLoans(blocks.main.mainFourHourBlock, mainnet_url)
  ...
  const ovmEightHourLoan = await fetchLoans(blocks.ovm.ovmEightHourBlock, optimism_url)
  const mainEightHourLoan = await fetchLoans(blocks.main.mainEightHourBlock, mainnet_url)
  ...
  const ovmTwelveHourLoan = await fetchLoans(blocks.ovm.ovmTwelveHourBlock, optimism_url)
  const mainTwelveHourLoan = await fetchLoans(blocks.main.mainTwelveHourBlock, mainnet_url)
  ...
  const ovmSixteenHourLoan = await fetchLoans(blocks.ovm.ovmSixteenHourBlock, optimism_url)
  const mainSixteenHourLoan = await fetchLoans(blocks.main.mainSixteenHourBlock, mainnet_url)
  ...
  const ovmTwentyHourLoan = await fetchLoans(blocks.ovm.ovmTwentyHourBlock, optimism_url)
  const mainTwentyHourLoan = await fetchLoans(blocks.main.mainTwentyHourBlock, mainnet_url)
  ...
  const ovmTwentyFourHourLoan = await fetchLoans(blocks.ovm.ovmTwentyFourHourBlock, optimism_url)
  const mainTwentyFourHourLoan = await fetchLoans(blocks.main.mainTwentyFourHourBlock, mainnet_url)
  ...
  const ovmTwoDayLoan = await fetchLoans(blocks.ovm.ovmTwoDayBlock, optimism_url)
  const mainTwoDayLoan = await fetchLoans(blocks.main.mainTwoDayBlock, mainnet_url)
  ...
  const ovmThreeDayLoan = await fetchLoans(blocks.ovm.ovmThreeDayBlock, optimism_url)
  const mainThreeDayLoan = await fetchLoans(blocks.main.mainThreeDayBlock, mainnet_url)
  ...
  const ovmFourDayLoan = await fetchLoans(blocks.ovm.ovmFourDayBlock, optimism_url)
  const mainFourDayLoan = await fetchLoans(blocks.main.mainFourDayBlock, mainnet_url)
  ...
  const ovmFiveDayLoan = await fetchLoans(blocks.ovm.ovmFiveDayBlock, optimism_url)
  const mainFiveDayLoan = await fetchLoans(blocks.main.mainFiveDayBlock, mainnet_url)
  ...
  const ovmSixDayLoan = await fetchLoans(blocks.ovm.ovmSixDayBlock, optimism_url)
  const mainSixDayLoan = await fetchLoans(blocks.main.mainSixDayBlock, mainnet_url)
  ...
  const ovmTenDayLoan = await fetchLoans(blocks.ovm.ovmTenDayBlock, optimism_url)
  const mainTenDayLoan = await fetchLoans(blocks.main.mainTenDayBlock, mainnet_url)
  ...
  const ovmFifteenDayLoan = await fetchLoans(blocks.ovm.ovmFifteenDayBlock, optimism_url)
  const mainFifteenDayLoan = await fetchLoans(blocks.main.mainFifteenDayBlock, mainnet_url)
  ...
  const ovmTwentyDayLoan = await fetchLoans(blocks.ovm.ovmTwentyDayBlock, optimism_url)
  const mainTwentyDayLoan = await fetchLoans(blocks.main.mainTwentyDayBlock, mainnet_url)
  ...
  const ovmTwentyFiveDayLoan = await fetchLoans(blocks.ovm.ovmTwentyFiveDayBlock, optimism_url)
  const mainTwentyFiveDayLoan = await fetchLoans(blocks.main.mainTwentyFiveDayBlock, mainnet_url)
  ...
  const ovmThirtyDayLoan = await fetchLoans(blocks.ovm.ovmThirtyDayBlock, optimism_url)
  const mainThirtyDayLoan = await fetchLoans(blocks.main.mainThirtyDayBlock, mainnet_url)
