...
export const block = async () => {
  ...
  const ovmTwentyFourHourBlock = await getBlock(
    times.twelveHourAgo,
    optimism_url
  )
  const mainTwentyFourHourBlock = await getBlock(
    times.twelveHourAgo,
    mainnet_url
  )
  ...
  const ovmTwentyFiveDayBlock = await getBlock(
    times.twentyFiveDayAgo,
    optimism_url
  )
  const mainTwentyFiveDayBlock = await getBlock(
    times.twentyFiveDayAgo,
    mainnet_url
  )
