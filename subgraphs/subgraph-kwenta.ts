...
export const getCrossMarginAccountById = async function <K extends keyof CrossMarginAccountResult>(url: string, options: SingleQueryOptions, args: CrossMarginAccountArgs<K>): Promise<Pick<CrossMarginAccountResult, K>> {
    const res = await axios.post(url, {
...
export const getCrossMarginAccounts = async function <K extends keyof CrossMarginAccountResult>(url: string, options: MultiQueryOptions<CrossMarginAccountFilter, CrossMarginAccountResult>, args: CrossMarginAccountArgs<K>): Promise<Pick<CrossMarginAccountResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<CrossMarginAccountFilter, CrossMarginAccountResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof CrossMarginAccountFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFundingRateUpdateById = async function <K extends keyof FundingRateUpdateResult>(url: string, options: SingleQueryOptions, args: FundingRateUpdateArgs<K>): Promise<Pick<FundingRateUpdateResult, K>> {
    const res = await axios.post(url, {
...
export const getFundingRateUpdates = async function <K extends keyof FundingRateUpdateResult>(url: string, options: MultiQueryOptions<FundingRateUpdateFilter, FundingRateUpdateResult>, args: FundingRateUpdateArgs<K>): Promise<Pick<FundingRateUpdateResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FundingRateUpdateFilter, FundingRateUpdateResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FundingRateUpdateFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export const getFuturesMarginAccountById = async function <K extends keyof FuturesMarginAccountResult>(url: string, options: SingleQueryOptions, args: FuturesMarginAccountArgs<K>): Promise<Pick<FuturesMarginAccountResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesMarginAccounts = async function <K extends keyof FuturesMarginAccountResult>(url: string, options: MultiQueryOptions<FuturesMarginAccountFilter, FuturesMarginAccountResult>, args: FuturesMarginAccountArgs<K>): Promise<Pick<FuturesMarginAccountResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesMarginAccountFilter, FuturesMarginAccountResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesMarginAccountFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type FuturesMarketFilter = {
    ...
    marketStats_?: FuturesCumulativeStat_filterFilter | null;
};
...
export const getFuturesOrderById = async function <K extends keyof FuturesOrderResult>(url: string, options: SingleQueryOptions, args: FuturesOrderArgs<K>): Promise<Pick<FuturesOrderResult, K>> {
    const res = await axios.post(url, {
...
export const getFuturesOrders = async function <K extends keyof FuturesOrderResult>(url: string, options: MultiQueryOptions<FuturesOrderFilter, FuturesOrderResult>, args: FuturesOrderArgs<K>): Promise<Pick<FuturesOrderResult, K>[]> {
    const paginatedOptions: Partial<MultiQueryOptions<FuturesOrderFilter, FuturesOrderResult>> = { ...options };
    ...
    if (options.first && options.first > MAX_PAGE) {
        ...
        paginatedOptions.orderBy = options.orderBy || "id";
        paginatedOptions.orderDirection = options.orderDirection || "asc";
        paginationKey = paginatedOptions.orderBy + (paginatedOptions.orderDirection === "asc" ? "_gt" : "_lt") as keyof FuturesOrderFilter;
        paginatedOptions.where = { ...options.where };
    }
...
export type FuturesPositionFilter = {
    ...
    accountType?: FuturesAccountTypeFilter | null;
    accountType_not?: FuturesAccountTypeFilter | null;
    accountType_in?: FuturesAccountTypeFilter[];
    accountType_not_in?: FuturesAccountTypeFilter[];
    isOpen?: boolean | null;
...
export type FuturesPositionResult = {
    ...
    accountType: Partial<FuturesAccountTypeResult>;
    isOpen: boolean;
...
export type FuturesPositionFields = {
    ...
    accountType: FuturesAccountTypeFields;
    isOpen: true;
    isLiquidated: true;
    trades: true;
    totalVolume: true;
